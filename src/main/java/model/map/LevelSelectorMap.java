...
public class LevelSelectorMap {
    private final int width;
    private final int height;
    private final Map<Point, java.util.List<Entity>> grid;
    private final Map<Entity, Point> entityPositions;

    public LevelSelectorMap(int width, int height) {
        this.width = width;
        this.height = height;
...
//    public LevelSelectorMap(LevelMap other) {
...
//    }
    ...
    public void setPosition(Entity entity, int newX, int newY) {
        ...
        if (oldPosition != null) {
            java.util.List<Entity> cell = grid.get(oldPosition);
            if (cell != null) {
                cell.remove(entity);
                if (cell.isEmpty()) {
     ...
     */
    public java.util.List<Entity> getEntitiesAt(int x, int y) {
        return grid.getOrDefault(new Point(x, y), java.util.List.of());
    }

    public java.util.List<Entity> getEntitiesAt(Point position) {
